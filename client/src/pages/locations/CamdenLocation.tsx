/*
 * CAMDEN SATELLITE PAGE
 * Dedicated high-converting location page for Camden removals.
 * Designed to rank for: "removals Camden", "man and van Camden",
 * "house removals NW1", "moving company Camden London"
 *
...
const REVIEWS = [
  {
    name: "Oliver B.",
    area: "Primrose Hill, NW1",
    rating: 5,
    text: "Octagon moved us from a Victorian terrace in Primrose Hill to Hampstead. The team navigated the narrow streets perfectly and handled our antiques with real care. Faultless from start to finish.",
    date: "March 2025",
  },
  {
    name: "Amelia C.",
    area: "Camden Town, NW1",
    rating: 5,
    text: "We had a very awkward third-floor flat with no lift in Camden Town. The crew handled it without a single complaint, wrapped everything meticulously and had us settled in by 4pm. Brilliant service.",
    date: "February 2025",
  },
  {
    name: "Daniel F.",
    area: "Kentish Town, NW5",
    rating: 5,
    text: "Second time using Octagon — this time for our office move in Kentish Town. Everything was done over the weekend with zero disruption to our Monday morning. Highly professional team.",
    date: "December 2024",
  },
];
...
const FAQS = [
  {
    q: "How much does a house removal in Camden cost?",
    a: "Our Camden removals start from £350 for a 1-bedroom flat and £680 for a 3-bedroom house. All prices are fixed — no hidden charges. We provide a free quote within 1 hour of your enquiry.",
  },
  {
    q: "Do you cover all of Camden including Primrose Hill, Kentish Town and Hampstead?",
    a: "Yes — we cover the entire London Borough of Camden including Camden Town, Primrose Hill, Kentish Town, Hampstead, Belsize Park, Kilburn, Gospel Oak, Holborn, and all NW1, NW3, NW5, NW6 postcodes.",
  },
  {
    q: "Camden streets can be very narrow — is that a problem?",
    a: "Not at all. Our team is experienced with Camden's Victorian terraces, narrow mews streets, and buildings without lifts. We carry the right vehicle sizes and use specialist equipment for awkward access situations.",
  },
  {
  ...
  {
    q: "How far in advance should I book a Camden removal?",
    a: "We recommend booking 2–4 weeks in advance for weekend moves in Camden, which are in high demand. However, we often accommodate last-minute bookings — call us on 0208 521 8000 to check availability.",
  },
  {
    q: "Are you insured for moves in Camden?",
    a: "Yes. We carry £50,000 goods-in-transit insurance per vehicle and £1,000,000 public liability insurance. Your belongings are fully protected throughout your Camden move.",
  },
];

// ── QUOTE FORM ────────────────────────────────────────────────────────────────
function CamdenQuoteForm() {
    ...
    <div className="relative w-full overflow-hidden" style={{ paddingBottom: "56.25%", backgroundColor: "#000" }}>
      {!playing ? (
        <>
          <img
            src={THUMBNAIL}
            alt="Camden Removals by Octagon — watch our team in action"
          ...
          <button
            ...
            aria-label="Play Camden removals video">
        ...
        <iframe
          ...
          title="Camden Removals by Octagon"
...
// ── MAIN PAGE ─────────────────────────────────────────────────────────────────
export default function CamdenLocation() {
    ...
    "@graph": [
      {
        ...
        "name": "Octagon Removals — Camden",
        "url": "https://octagonremovals.co.uk/locations/camden",
        "telephone": "+442085218000",
        "email": "info@octagonremovals.co.uk",
        "description": "Professional house and office removals in Camden, North London. Fixed price, fully insured, 5-star rated. Covering NW1, NW3, NW5, Camden Town, Primrose Hill, Kentish Town, Hampstead.",
        "areaServed": {
          "@type": "Place",
          "name": "Camden, London"
        },
  ...
  return (
    <>
      <Helmet>
        <title>Camden Removals | Fixed Price, Fully Insured | Octagon Removals</title>
        <meta name="description" content="Professional removals in Camden, London. Fixed price quotes, fully insured, 4.9★ rated. Covering Camden Town, Primrose Hill, Kentish Town, Hampstead, NW1, NW3, NW5. Call 0208 521 8000 for a free quote within 1 hour." />
        <meta name="keywords" content="removals Camden, house removals Camden, man and van Camden, moving company NW1, Camden removals company, Primrose Hill removals, Kentish Town removals, Hampstead removals" />
        <link rel="canonical" href="https://octagonremovals.co.uk/locations/camden" />
        <meta property="og:title" content="Camden Removals | Octagon Removals — Fixed Price, Fully Insured" />
        <meta property="og:description" content="Professional house and office removals in Camden. Fixed price, 4.9★ rated, fully insured. Free quote within 1 hour." />
      ...
      <div style={{ backgroundColor: SAND, minHeight: "100vh" }}>
        ...
        <section style={{ backgroundColor: CHARCOAL, paddingTop: "80px" }}>
          <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-20 grid lg:grid-cols-2 gap-12 items-center">
            {/* Left — headline + trust pills + CTAs */}
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              ...
              <div className="flex items-center gap-2 mb-6 text-xs" style={{ color: "#6a7a8a", fontFamily: "DM Sans, sans-serif" }}>
                ...
                <span>/</span>
                <span style={{ color: GOLD }}>Camden</span>
              </div>
              ...
              <p className="mb-6 leading-relaxed" style={{ color: "#b0bec5", fontFamily: "DM Sans, sans-serif", fontSize: "1rem", maxWidth: "480px" }}>
                Premium house and office removals across Camden — Primrose Hill, Kentish Town, Hampstead, Belsize Park and beyond. Fixed price, fully insured, 4.9★ rated by over 323 London families.
              </p>
            ...
            <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.55, delay: 0.2 }}
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                <p className="text-xs" style={{ color: "#6a7a8a", fontFamily: "DM Sans, sans-serif" }}>
                  Real footage — our team completing a full house move in Camden
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  { title: "House & Flat Removals", desc: "From studio flats in Camden Town to 5-bedroom houses in Hampstead — we handle every size of residential move in Camden with the same level of care." },
                  { title: "Packing & Unpacking", desc: "Professional packing using double-walled boxes, tissue paper and bubble wrap. We pack everything safely and unpack at your new Camden address." },
                  { title: "Furniture Dismantling & Assembly", desc: "Wardrobes, beds, flat-pack furniture — our team dismantles and reassembles everything at your new Camden address." },
                  { title: "Office Removals", desc: "Weekend and out-of-hours office moves across Camden and the City. Minimal disruption, maximum efficiency." },
                  { title: "Storage Solutions", desc: "Short and long-term storage available if you need time between your Camden move-out and move-in dates." },
                ].map(({ title, desc }) => (
              ...
              <div className="mt-8 p-5" style={{ backgroundColor: "#fff", border: "1px solid #e8e4dc" }}>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Camden Town", "Primrose Hill", "Kentish Town", "Hampstead", "Belsize Park", "Kilburn", "Gospel Oak", "Holborn", "Chalk Farm", "Swiss Cottage", "NW1", "NW3", "NW5", "NW6", "WC1"].map(area => (
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-12">
            <div className="text-center mb-14">
              ...
              <h2 className="mt-2" style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(1.8rem, 3vw, 2.6rem)", fontWeight: 600, color: CHARCOAL }}>
                Your Camden Move in Four Simple Steps
              </h2>
            </div>
        ...
        <section className="py-16 px-6 text-center" style={{ backgroundColor: CHARCOAL }}>
          <div className="max-w-2xl mx-auto">
            ...
            <p className="mt-6 text-xs" style={{ color: "#4a5a6a", fontFamily: "DM Sans, sans-serif" }}>
              Also serving:{" "}
              {["Islington", "Hackney", "Hampstead", "Kentish Town", "Primrose Hill", "Belsize Park"].map((a, i, arr) => (
                <span key={a}>
