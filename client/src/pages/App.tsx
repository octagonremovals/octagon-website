...
import StorageFaqPage from "./pages/StorageFaqPage";
...
import HouseRemovalsPage from "./pages/HouseRemovalsPage";
import PackingServicePage from "./pages/PackingServicePage";
import ClearanceDisposalPage from "./pages/ClearanceDisposalPage";
import FurnitureDismantlingPage from "./pages/FurnitureDismantlingPage";
import PianoMovingPage from "./pages/PianoMovingPage";
import InternationalRemovalsPage from "./pages/InternationalRemovalsPage";
import InternationalCountryPage from "./pages/InternationalCountryPage";
import PorteragePage from "./pages/PorteragePage";
...
function Router() {
  return (
    <Switch>
      ...
      {/* Dedicated service pages - must come before the dynamic :slug route */}
      <Route path="/services/office-relocation" component={OfficeRelocationPage} />
      <Route path="/services/house-removals" component={HouseRemovalsPage} />
      <Route path="/services/packing-unpacking" component={PackingServicePage} />
      <Route path="/services/clearance-disposal" component={ClearanceDisposalPage} />
      ...
      <Route path="/faq/storage" component={StorageFaqPage} />
