...
export const locationsData: Record<string, LocationData> = {
  ...
  "bromley-south": {
    ...
    slug: "orpington",
    phone: "0208 521 8000",
    heroTagline: "Premium removals across Orpington, St Mary Cray, Petts Wood and all BR5/BR6 postcodes. Fixed-price, fully insured.",
    intro: "Orpington and the surrounding BR5/BR6 area is well served by our dedicated South East London team. From the suburban streets of Petts Wood to the more rural areas around Chelsfield, our team is experienced in all Orpington property types. We provide fixed-price quotes and a fully insured service for all Orpington moves.",
    boroughs: ["Orpington", "St Mary Cray", "Petts Wood", "Chelsfield", "Farnborough", "Green Street Green", "Crofton", "Locksbottom", "Goddington", "Ramsden"],
    faqs: [
      { q: "Do you cover all Orpington postcodes?", a: "Yes, we cover all BR5 and BR6 postcodes including Orpington, St Mary Cray, Petts Wood, and Chelsfield." },
      { q: "Can you move from Orpington to London?", a: "Yes, we regularly move clients between Orpington and all parts of London. Our fixed-price quotes cover all distances." },
      { q: "Do you offer packing services in Orpington?", a: "Yes, our full packing service is available across all Orpington areas." },
      { q: "How much does a house removal in Orpington cost?", a: "Costs vary depending on property size and distance. We provide free, fixed-price quotes with no obligation." },
    ],
    localReviews: [
      { name: "Alan T.", area: "Orpington", text: "Moved from Orpington to Bromley. The team were excellent — professional, careful, and completed the move ahead of schedule." },
      { name: "Sandra K.", area: "Petts Wood", text: "Octagon handled our Petts Wood house move with great care. Fixed price was exactly as quoted. Highly recommend." },
      { name: "Robert H.", area: "Chelsfield", text: "Brilliant service from start to finish. The team were friendly, efficient, and took great care of our belongings." },
    ],
  },
