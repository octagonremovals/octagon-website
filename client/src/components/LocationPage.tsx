  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#F5F3EF" }}>
        ...
        <div className="container py-5">
          <div className="flex flex-wrap items-center justify-center gap-6 lg:gap-10">
            {[
              ...
              { icon: Award, text: "Insured up to £50,000 per vehicle" },
      ...
      <section className="py-16 lg:py-24">
        <div className="container">
          <div className="max-w-3xl">
            <span className="eyebrow block mb-3">Local Expertise</span>
            <h2
      ...
      <section className="py-16 lg:py-24" style={{ backgroundColor: "#0F1923" }}>
        <div className="container">
          <div className="mb-12">
            <span className="eyebrow block mb-3">What We Offer in {data.name}</span>
            <h2
      ...
      <section className="py-16 lg:py-24">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="eyebrow block mb-3">Why Choose Octagon in {data.name}</span>
              <h2
                className="text-3xl lg:text-4xl font-semibold mb-6"
                style={{ fontFamily: "Cormorant Garamond, serif", color: "#0F1923" }}
              >
            ...
            >
              <span className="eyebrow block mb-3">Get Your Free Quote</span>
              <h3
      ...
      {locationPhotos.length > 0 && (
        <section className="py-16 lg:py-24">
          <div className="container">
            <div className="mb-10">
              <span className="eyebrow block mb-3">Our Work in {data.name}</span>
              <h2
                className="text-3xl lg:text-4xl font-semibold"
                style={{ fontFamily: "Cormorant Garamond, serif", color: "#0F1923" }}
              >
      ...
      <section className="py-16 lg:py-24" style={{ backgroundColor: "#0F1923" }}>
        <div className="container text-center">
          <span className="eyebrow block mb-4">Ready to Move in {data.name}?</span>
          <h2
